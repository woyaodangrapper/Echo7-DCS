...
using ECHO.Infrastructure.Redis.Caching.Core;
...
using ECHO.Infrastructure.Redis.Providers.StackExchange;

namespace ECHO.Infrastructure.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:ECHO.Infrastructure.Redis.Redis.DefaultRedisCachingProvider"/> class.
    /// </summary>
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
            ...
            // see https://github.com/dotnetcore/ECHO.Infrastructure.Redis/pull/199 for more information
