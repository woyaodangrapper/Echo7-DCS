namespace ECHO.Infrastructure.Redis.Caching.Core.Diagnostics
{
    /// <summary>
    /// Extension methods on the DiagnosticListener class to log ECHO.Infrastructure.Redis
    /// </summary>
    public static class CachingDiagnosticListenerExtensions
    {
        ...
        private const string CachingPrefix = nameof(ECHO.Infrastructure.Redis.Caching);
