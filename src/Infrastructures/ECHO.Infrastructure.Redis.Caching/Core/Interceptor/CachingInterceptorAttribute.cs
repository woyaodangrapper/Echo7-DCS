namespace ECHO.Infrastructure.Redis.Caching.Core.Interceptor
{
    using System;

    /// <summary>
    /// ECHO.Infrastructure.Redis interceptor attribute.
    /// </summary>
    ...
    public class CachingInterceptorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the cache provider name. The default value is ECHO.Infrastructure.RedisInterceptorOptions.CacheProviderName"/>
        /// </summary>
        /// <value>The cache key prefix.</value>
