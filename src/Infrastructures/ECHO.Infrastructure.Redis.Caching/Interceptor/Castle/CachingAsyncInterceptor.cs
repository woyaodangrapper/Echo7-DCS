...
namespace ECHO.Infrastructure.Redis.Caching.Interceptor.Castle
{
    /// <summary>
    ...
    public sealed class CachingAsyncInterceptor : IAsyncInterceptor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Dcs.Infa.Caching.CachingAsyncInterceptor"/> class.
        /// </summary>
