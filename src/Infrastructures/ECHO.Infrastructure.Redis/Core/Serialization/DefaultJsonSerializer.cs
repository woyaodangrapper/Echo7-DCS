using ECHO.Infrastructure.Core.Json;
using ECHO.Infrastructure.Redis.Core.Internal;

namespace ECHO.Infrastructure.Redis.Core.Serialization
{
    /// <summary>
    ...
    public class DefaultJsonSerializer : ISerializer
    {
        ...
        /// The json serializer.
        /// </summary>
        private static readonly JsonSerializerOptions jsonSerializerOption = SystemTextJson.GetDcsDefaultOptions();
