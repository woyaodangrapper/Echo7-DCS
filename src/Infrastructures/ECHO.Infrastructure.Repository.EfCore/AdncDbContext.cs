namespace ECHO.Infrastructure.Repository.EfCore;

public abstract class DcsDbContext : DbContext
{
    private readonly IEntityInfo _entityInfo;

    protected DcsDbContext(DbContextOptions options, IEntityInfo entityInfo)
        : base(options)
    {
