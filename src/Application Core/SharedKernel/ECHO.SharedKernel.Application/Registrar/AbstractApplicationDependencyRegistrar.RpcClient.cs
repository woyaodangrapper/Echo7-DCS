...
using ECHO.Infrastructure.Consul.Discover.GrpcResolver;
using ECHO.Infrastructure.Consul.Discover.Handler;
using ECHO.SharedKernel.Const.AppSettings;
using ECHO.SharedKernel.Const.RegistrationCenter;
using ECHO.SharedKernel.Rpc.Http.Handlers;
using ECHO.SharedKernel.Rpc.Http.Handlers.Token;
using Refit;
...
public abstract partial class AbstractApplicationDependencyRegistrar
{
     ...
     where TRestClient : class
    {
        ...
        var contentSerializer = new SystemTextJsonContentSerializer(SystemTextJson.GetDcsDefaultOptions());
