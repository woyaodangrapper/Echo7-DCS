...
public abstract class DcsControllerBase : ControllerBase
{
    /// <summary>
    /// ECHO.SharedKernel.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="ECHO.SharedKernel.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(ECHO.SharedKernel.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
