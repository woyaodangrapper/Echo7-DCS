...
[Route("usr/users")]
[ApiController]
public class UserController : DcsControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [DcsAuthorize(PermissionConsts.User.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [DcsAuthorize(PermissionConsts.User.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [DcsAuthorize(PermissionConsts.User.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpPut("{id}/roles")]
    [DcsAuthorize(PermissionConsts.User.SetRole)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpPut("{id}/status")]
    [DcsAuthorize(PermissionConsts.User.ChangeStatus)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet("page")]
    [DcsAuthorize(PermissionConsts.User.GetList)]
    [ProducesResponseType(StatusCodes.Status200OK)]
