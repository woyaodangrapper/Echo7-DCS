...
[Route("usr/menus")]
[ApiController]
public class MenuController : DcsControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [DcsAuthorize(PermissionConsts.Menu.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [DcsAuthorize(PermissionConsts.Menu.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [DcsAuthorize(PermissionConsts.Menu.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [DcsAuthorize(PermissionConsts.Menu.GetList)]
